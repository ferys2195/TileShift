...
export default function Footer() {
  return (
    <div className="items-center justify-between space-y-2.5 text-gray-500 lg:flex">
      <div className="text-center">Copyright © 2025 by Fery Irawan</div>
      <div className="flex items-center justify-center gap-1.5">
        ...
        <a href="https://www.linkedin.com/in/ferys2195/">
          <Button size={"icon"} variant={"outline"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
        ...
        <a href="https://facebook.com/ferys2195">
          <Button size={"icon"} variant={"outline"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
        ...
        <a href="https://instagram.com/ferys2195">
          <Button size={"icon"} variant={"outline"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
